...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 02 déc. 2021 à 22:13
...
INSERT INTO `agent` (`IdAgent`, `MatriculeAgent`, `NomAgent`, `PrenomsAgent`, `CiviliteAgent`, `NomJeuneFilleAgent`, `SexeAgent`, `DateNaissanceAgent`, `TelAgent`, `EmailAgent`, `DatePriseServiceAgent`, `SituationMatrimonialeAgent`, `DateCreationAgent`, `PasswordAgent`, `IdEmploi`, `IdFonction`) VALUES
(1, '14123', 'COULIBALY', 'Ruth Marlène', 'Madame', '', 'F', '2021-01-01', '', 'tiemoko.coulibaly@uvci.edu.ci', NULL, 'Marie', '2021-12-01', '$2y$10$KNMLkT2epNoI.WI.q7qmi.VFt/Ypmo.kD8ACBrozutez9SUNzwEhq', -1, -1);
...
CREATE TABLE IF NOT EXISTS `ecole` (
  ...
  `TelEcole` varchar(255) NOT NULL,
  `EmailEcole` varchar(255) NOT NULL,
  `LocaliteEcole` bigint(20) NOT NULL,
  PRIMARY KEY (`IdEcole`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
