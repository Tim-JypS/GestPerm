    ...
    <body>
        ...
        <header id="top">
            ...
            <nav class="navbar  navbar-expand-lg navbar-light top-navbar" data-toggle="sticky-onscroll">
                <div class="container">
                    <a class="navbar-brand" href="blog-details.php#"><img src="images/green-logo.png" alt="logo" /></a>
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav pull-right">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="blog-details.php#" data-toggle="modal" data-target="#getInToucheModal">GET A QUOTE</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="single-blog">
                                ...
                                <div class="blog-wrapper">
                                    <a href="blog-details.php#"><img src="images/blog-img/single-blog.jpg" alt="blog-img" class="img-responsive" /></a>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="go-to-content-wrapper blog-det-page">
                                ...
                                <p class="link"><a href="index.php#latestBlog"><span class="icon-arrow-left"></span>See Our Latest Blog</a></p>
                            </div>
                        </div>
                        <div class="col-md-6">
            ...
            <footer>
                ...
                <!--scroll to top-->
                <a class="top-btn page-scroll" href="blog-details.php#top"><span class="icon-chevron-up b-clor regular-text text-center"></span></a>
                <!--end scroll to top-->
            </footer>
            <!-- ++++ End of Footer ++++ -->
            <!-- +++++++++++++ Modal Get in  touch +++++++++++++ -->
