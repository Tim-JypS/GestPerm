    ...
    <body>
        ...
        <header id="top">
            ...
            <nav class="navbar  navbar-expand-lg navbar-light top-navbar" data-toggle="sticky-onscroll">
                <div class="container">
                    <a class="navbar-brand" href="blog.php#"><img src="images/green-logo.png" alt="logo" /></a>
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav pull-right">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="blog.php#" data-toggle="modal" data-target="#getInToucheModal">GET A QUOTE</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="container">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="single-blog">
                                <div class="blog-wrapper">
                                    <a href="blog-details.php"><img src="images/blog-img/blog-home-3.jpg" alt="blog-img" class="img-responsive" /></a>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="single-blog">
                                <div class="blog-wrapper">
                                    <a href="blog-details.php"><img src="images/blog-img/blog-home-4.jpg" alt="blog-img" class="img-responsive" /></a>
                                </div>
                                <div class="date-wrapper">
                                    <span class="blog-day date">20</span>
                                    <span class="blog-month date">Oct</span>
                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-center">
                                    <li class="page-item disabled">
                                        <a class="page-link" href="blog.php#" tabindex="-1">Previous</a>
                                    </li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="go-to-content-wrapper">
                                ...
                                <p class="link"><a href="index.php#services"><span class="icon-arrow-left"></span>See Our Services</a></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="go-to-content-wrapper">
            ...
            <footer>
                ...
                <!--scroll to top-->
                <a class="top-btn page-scroll" href="blog.php#top"><span class="icon-chevron-up b-clor regular-text text-center"></span></a>
                <!--end scroll to top-->
            </footer>
            <!-- ++++ End of Footer ++++ -->
            <!-- +++++++++++++ Modal Portfolio +++++++++++++ -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div id="Protfolio-modal" class="carousel slide" data-ride="carousel">
                                            ...
                                            <a class="carousel-control-prev" href="blog.php#Protfolio-modal" role="button" data-slide="prev">
                                                <span class="icon-chevron-left" aria-hidden="true"></span>
                                            </a>
                                            <a class="carousel-control-next" href="blog.php#Protfolio-modal" role="button" data-slide="next">
