    ...
    <body>
        ...
        <header id="top">
            ...
            <nav class="navbar  navbar-expand-lg navbar-light top-navbar" data-toggle="sticky-onscroll">
                <div class="container">
                    <a class="navbar-brand" href="contact.php#"><img src="images/green-logo.png" alt="logo" /></a>
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav pull-right">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="contact.php#" data-toggle="modal" data-target="#getInToucheModal">GET A QUOTE</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="seo-audit-section">
                                <form id="contactUsForm" class="validation-form">
                                    <h3>Contact With Us</h3>
                                    <div class="input-group">
                                        <span class="input-group-addon icon-user" id="user-name"></span>
                                        <input type="text" class="form-control white-ph" placeholder="Enter your name" aria-label="user-name"   name="contactUsName">
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-addon icon-envelope" id="email-address-contact"></span>
                                        <input type="text" class="form-control white-ph" placeholder="Enter your e-mail" aria-label="email-address" name="contactUsEmail">
                                    </div>
                                    <div class="input-group">
                                        <span class="input-group-addon icon-telephone2" id="phone-number"></span>
                                        <input type="text" class="form-control white-ph" placeholder="Enter your phone number" aria-label="phone-number"  name="contactUsPhone">
                                    </div>
                                    <div class="input-group">
                                        <textarea class="form-control white-ph" placeholder="Enter your message" name="contactUsMsg"></textarea>
                                    </div>
                                    <div class="input-group">
            ...
            <footer>
                ...
                <!--scroll to top-->
                <a class="top-btn page-scroll" href="contact.php#top"><span class="icon-chevron-up b-clor regular-text text-center"></span></a>
                <!--end scroll to top-->
            </footer>
            <!-- ++++ End of Footer ++++ -->
            <!-- +++++++++++++ Modal Get in  touch +++++++++++++ -->
