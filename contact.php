                   ...
                   <div class="contact-wrap-form">
                        <form id="contactForm">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="phone_number" id="phone_number" required data-error="Veuillez entrer votre téléphone" class="form-control" placeholder="Téléphone">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="msg_subject" id="msg_subject" class="form-control" required data-error="Veuillez entrer le sujet" placeholder="Sujet">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        <textarea name="message" class="form-control" id="message" cols="30" rows="8" required data-error="Veuillez saisir votre message" placeholder="Votre Message"></textarea>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
