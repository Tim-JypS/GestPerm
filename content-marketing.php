    ...
    <body>
        ...
        <header id="top">
            ...
            <nav class="navbar  navbar-expand-lg navbar-light top-navbar" data-toggle="sticky-onscroll">
                <div class="container">
                    <a class="navbar-brand" href="content-marketing.php#"><img src="images/green-logo.png" alt="logo" /></a>
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    ...
                                    <a class="dropdown-item" href="search-engine-marketing.php">
                                        ...
                                        <a class="dropdown-item active" href="content-marketing.php"> <span class="icon-register"></span> Content Marketing</a>
                                ...
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="content-marketing.php#" data-toggle="modal" data-target="#getInToucheModal">GET A QUOTE</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="service-details-container">
                                ...
                                <div class="service-details-content">
                                    ...
                                    <div class="btn-wrapper">
                                        <a href="content-marketing.php#" class="btn btn-primary">Learn More</a>
                                        <a href="content-marketing.php#" class="btn btn-transparent">Our Portfolio</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <footer>
                ...
                <!--scroll to top-->
                <a class="top-btn page-scroll" href="content-marketing.php#top"><span class="icon-chevron-up b-clor regular-text text-center"></span></a>
                <!--end scroll to top-->
            </footer>
            <!-- ++++ End of Footer ++++ -->
            <!-- +++++++++++++ Modal Portfolio +++++++++++++ -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div id="Protfolio-modal" class="carousel slide" data-ride="carousel">
                                            ...
                                            <a class="carousel-control-prev" href="content-marketing.php#Protfolio-modal" role="button" data-slide="prev">
                                                <span class="icon-chevron-left" aria-hidden="true"></span>
                                            </a>
                                            <a class="carousel-control-next" href="content-marketing.php#Protfolio-modal" role="button" data-slide="next">
