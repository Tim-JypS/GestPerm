...
<html lang="zxx">
    <head>
        ...
        <title>Home | Digital Business Solution - Responsive Website Template</title>
        <!-- ++++ favicon ++++ -->
    ...
    <body>
        ...
        <header id="top">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="float-left">
                                <ul>
                                    <li><span class="icon-map-marker"></span>Brooklyn, NY 10036, United States</li>
                                    <li><span class="icon-telephone"></span>+123456200</li>
                                </ul>
                            </div>
            ...
            <!-- End of most top info -->

            <!-- navbar Start -->
            <nav class="navbar  navbar-expand-lg navbar-light top-navbar" data-toggle="sticky-onscroll">
                <div class="container">
                    <a class="navbar-brand" href="index.php#"><img src="images/green-logo.png" alt="logo" /></a>
                        ...
                        <ul class="navbar-nav pull-right">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    <a class="dropdown-item" href="search-engine-optimization.php"> <span class="icon-find-replace"></span>Search Engine Optimization</a>
                                    <a class="dropdown-item" href="search-engine-marketing.php">
                                        <span class="icon-network"></span>Search Engine Marketing</a>
                                    <a class="dropdown-item" href="social-media-marketing.php"> <span class="icon-group-work"></span>Social Media Marketing</a>
                                    <a class="dropdown-item" href="pay-per-click.php"> <span class="icon-finger-tap"></span>Pay Per Click</a>
                                    <a class="dropdown-item" href="content-marketing.php"> <span class="icon-register"></span> Content Marketing</a>
                                    <a class="dropdown-item" href="custom-website-design.php"> <span class="icon-stream-check"></span>Custom Website Design</a>
                                </div>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="btn btn-primary" href="index.php#" data-toggle="modal" data-target="#getInToucheModal">GET A QUOTE</a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <section>
            <div id="myCarousel" class="carousel slide bg-inverse" data-ride="carousel">
                        ...
                        <div class="carousel-caption left-caption">
                            <div class="dis-table">
                                <div class="caption-content-wrapper">
                                    <div class="container">
                                        <h1 class="wow fadeInDown"  data-wow-duration="1.5s">We Provide all kinds of <br /> SEO services  and help <br /> to improve seo ranking</h1>
                                        <div class="btn-wrapper wow fadeInUp" data-wow-duration="2s">
                                            <a href="index.php#services" class="btn btn-primary page-scroll">Learn More</a>
                                            <a href="index.php#ourPortfolio" class="btn btn-transparent page-scroll">Our Portfolio</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="carousel-item" style="background: url(images/slider2.jpg)">
                        ...
                        <div class="carousel-caption right-caption">
                            <div class="dis-table">
                                <div class="caption-content-wrapper">
                                    <div class="container">
                                        <h1 class="wow fadeInRight"  data-wow-duration="1.5s">We are creative digital, <br /> enthusiastic agency &AMP; <br /> marketing expert</h1>
                                        <div class="btn-wrapper wow fadeInUp" data-wow-duration="2s">
                                            <a href="index.php#services" class="btn btn-primary page-scroll">Learn More</a>
                                            <a href="index.php#ourPortfolio" class="btn btn-transparent page-scroll">Our Portfolio</a>
                                        </div>
                    ...
                    <div class="carousel-item" style="background: url(images/slider3.jpg)">
                        ...
                        <div class="carousel-caption left-caption">
                            <div class="dis-table">
                                <div class="caption-content-wrapper">
                                    <div class="container">
                                        <h1 class="wow fadeInLeft" data-wow-duration="1.5s">We are a creative studio <br /> focusing on culture, luxury,<br /> editorial, art &AMP; design . </h1>
                                        <div class="btn-wrapper wow fadeInUp" data-wow-duration="2s">
                                            <a href="index.php#services" class="btn btn-primary page-scroll">Learn More</a>
                                            <a href="index.php#ourPortfolio" class="btn btn-transparent page-scroll">Our Portfolio</a>
                                        </div>
                ...
                <a class="carousel-control-prev" href="index.php#myCarousel" role="button" data-slide="prev">
                    <span class=" icon-chevron-left" aria-hidden="true"></span>
                </a>
                <a class="carousel-control-next" href="index.php#myCarousel" role="button" data-slide="next">
            ...
            <div class="green-box-wrapper">
                ...
                <div class="float-left darker-green">
                    <div class="green-box-content">
                        ...
                        <a href="index.php#services" class="btn white-btn page-scroll">Read More</a>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 more-btn-wrapper">
                        <a href="portfolio.php" class="btn btn-primary"> See More Portfolio</a>
                    </div>
                    <!--end  see more btn-->
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <a href="index.php#" class="btn btn-primary">Meet Our Team</a>
                    </div>
                    <!--team members-->
                    <div class="col-md-6">
        ...
        <section class="latest-blog-section" id="latestBlog">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="single-blog">
                            <div class="blog-wrapper first-blog">
                                <a href="blog-details.php"><img src="images/blog-img/blog-home-1.jpg" alt="blog-img" class="img-responsive" /></a>
                            </div>
                            <div class="date-wrapper">
                                <span class="blog-day date">20</span>
                                <span class="blog-month date">Oct</span>
                            </div>
                            <h4><a href="blog-details.php">How to Create Contents That Get Traffic.</a></h4>
                            <!--blog social section-->
                    ...
                    <!--see more btn-->
                    <div class="col-md-12 more-btn-wrapper">
                        <a href="blog.php" class="btn btn-primary"> See More Blog</a>
                    </div>
                    <!--end  see more btn-->
                </div>
            </div>
        ...
        <footer>
            <div class="container">
                <div class="row">
                    <!--logo bottom-->
                    <div class="col-md-3">
                        <a href="index.php" class="brand"><img src="images/white-logo.png" alt="logo" /></a>
                    ...
                    <div class="col-md-3">
                        <ul>
                            ...
                            <li><a href="custom-website-design.php">Custom Website Design</a></li>
                        </ul>
                    </div>
                    <!--service end-->
                    <!--support start-->
            ...
            <!--scroll to top-->
            <a class="top-btn page-scroll" href="index.php#top"><span class="icon-chevron-up b-clor regular-text text-center"></span></a>
            <!--end scroll to top-->
        </footer>
        <!-- ++++ End of Footer ++++ -->
        <!-- +++++++++++++ Modal Portfolio +++++++++++++ -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div id="Protfolio-modal" class="carousel slide" data-ride="carousel">
                                        ...
                                        <a class="carousel-control-prev" href="index.php#Protfolio-modal" role="button" data-slide="prev">
                                            <span class="icon-chevron-left" aria-hidden="true"></span>
                                        </a>
                                        <a class="carousel-control-next" href="index.php#Protfolio-modal" role="button" data-slide="next">
                                            <span class="icon-chevron-right" aria-hidden="true"></span>
                                        </a>
                                    </div>
                                </div>
