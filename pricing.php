    ...
    <body>
        ...
        <header id="top">
            ...
            <nav class="navbar  navbar-expand-lg navbar-light top-navbar" data-toggle="sticky-onscroll">
                <div class="container">
                    <a class="navbar-brand" href="pricing.php#"><img src="images/green-logo.png" alt="logo" /></a>
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav pull-right">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="pricing.php#" data-toggle="modal" data-target="#getInToucheModal">GET A QUOTE</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="price-table">
                                ...
                                <a href="pricing.php#" class="btn btn-primary">Get Free</a>
                            </div>
                        </div>
                        <!-- End of price table -->
                        <!--price table start -->
                        <div class="col-md-4">
                            <div class="price-table">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes</p>
                                <a href="pricing.php#" class="btn btn-primary">Buy Now</a>
                            </div>
                        </div>
                        <!-- End of price table -->
                        <!--price table start -->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="go-to-content-wrapper">
                                ...
                                <h4>Our Services</h4>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam ac posuere metus.</p>
                                <p class="link"><a href="index.php#services">See Our Services<span class="icon-arrow-right"></span></a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <footer>
                ...
                <!--scroll to top-->
                <a class="top-btn page-scroll" href="pricing.php#top"><span class="icon-chevron-up b-clor regular-text text-center"></span></a>
                <!--end scroll to top-->
            </footer>
            <!-- ++++ End of Footer ++++ -->
            <!-- +++++++++++++ Modal Portfolio +++++++++++++ -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div id="Protfolio-modal" class="carousel slide" data-ride="carousel">
                                            ...
                                            <a class="carousel-control-prev" href="pricing.php#Protfolio-modal" role="button" data-slide="prev">
                                                <span class="icon-chevron-left" aria-hidden="true"></span>
                                            </a>
                                            <a class="carousel-control-next" href="pricing.php#Protfolio-modal" role="button" data-slide="next">
