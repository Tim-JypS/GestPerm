...
<html lang="zxx">
    <head>
        ...
        <title>Social Media Marketing | Digital Business Solution - Responsive Website Template</title>
        <!-- ++++ favicon ++++ -->
    ...
    <body>
        ...
        <header id="top">
            ...
            <nav class="navbar  navbar-expand-lg navbar-light top-navbar" data-toggle="sticky-onscroll">
                <div class="container">
                    <a class="navbar-brand" href="social-media-marketing.php#"><img src="images/green-logo.png" alt="logo" /></a>
                            ...
                            <li class="nav-item dropdown active">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                    ...
                                    <a class="dropdown-item" href="search-engine-marketing.php">
                                        ...
                                        <a class="dropdown-item active" href="social-media-marketing.php"> <span class="icon-group-work"></span>Social Media Marketing</a>
                                ...
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="social-media-marketing.php#" data-toggle="modal" data-target="#getInToucheModal">GET A QUOTE</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <section class="inner-banner-wrapper paralaxbg smm-banners" data-paralaxbg-speed="2">
                <div class="overlay">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="service-details-container">
                                <div class="service-left-img-wrapper" >
                                    <img src="images/smm-inner-page-img-1.jpg" alt="service img" />
                                </div>
                                <div class="service-details-content">
                                    ...
                                    <div class="btn-wrapper">
                                        <a href="social-media-marketing.php#" class="btn btn-primary">Learn More</a>
                                        <a href="social-media-marketing.php#" class="btn btn-transparent">Our Portfolio</a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <section class="start-project">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="contact.php" class="btn btn-primary">Start Project</a>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="go-to-content-wrapper">
                                ...
                                <p class="link"><a href="portfolio.php">See Our Portfolio <span class="icon-arrow-right"></span></a></p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="go-to-content-wrapper">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam ac posuere metus.</p>
                                <p class="link"><a href="pricing.php">See Pricing Plan <span class="icon-arrow-right"></span></a></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <footer>
                ...
                <!--scroll to top-->
                <a class="top-btn page-scroll" href="social-media-marketing.php#top"><span class="icon-chevron-up b-clor regular-text text-center"></span></a>
                <!--end scroll to top-->
            </footer>
            <!-- ++++ End of Footer ++++ -->
            <!-- +++++++++++++ Modal Portfolio +++++++++++++ -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div id="Protfolio-modal" class="carousel slide" data-ride="carousel">
                                            ...
                                            <a class="carousel-control-prev" href="social-media-marketing.php#Protfolio-modal" role="button" data-slide="prev">
                                                <span class="icon-chevron-left" aria-hidden="true"></span>
                                            </a>
                                            <a class="carousel-control-next" href="social-media-marketing.php#Protfolio-modal" role="button" data-slide="next">
