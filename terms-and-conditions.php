...
<html lang="zxx">
    <head>
        ...
        <title>Terms and Conditions | Digital Business Solution - Responsive Website Template</title>
        <!-- ++++ favicon ++++ -->
    ...
    <body>
        ...
        <header id="top">
            ...
            <nav class="navbar  navbar-expand-lg navbar-light top-navbar" data-toggle="sticky-onscroll">
                <div class="container">
                    <a class="navbar-brand" href="terms-and-conditions.php#"><img src="images/green-logo.png" alt="logo" /></a>
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                        <ul class="navbar-nav pull-right">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <li class="nav-item">
                                    <a class="btn btn-primary" href="terms-and-conditions.php#" data-toggle="modal" data-target="#getInToucheModal">GET A QUOTE</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <section class="inner-banner-wrapper paralaxbg terms-conditions-banners" data-paralaxbg-speed="2">
                <div class="overlay">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
            ...
            <!-- ++++ End of terms and conditions content section ++++ -->
            ...
            <footer>
                ...
                <!--scroll to top-->
                <a class="top-btn page-scroll" href="terms-and-conditions.php#top"><span class="icon-chevron-up b-clor regular-text text-center"></span></a>
                <!--end scroll to top-->
            </footer>
            <!-- ++++ End of Footer ++++ -->
            <!-- +++++++++++++ Modal Get in  touch +++++++++++++ -->
